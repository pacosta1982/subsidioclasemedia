...
@section('title', trans('admin.workflow-state.actions.index'))
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> {{ trans('admin.workflow-state.actions.index') }}
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'workflow_id'">{{ trans('admin.workflow-state.columns.workflow_id') }}</th>

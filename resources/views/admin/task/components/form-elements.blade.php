...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('farm'), 'has-success': fields.farm && fields.farm.valid }">
    <label for="farm" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.task.columns.farm') }}</label>
        <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" v-model="form.farm" v-validate="'required'" @input="validate($event)" class="form-control" :class="{'form-control-danger': errors.has('farm'), 'form-control-success': fields.farm && fields.farm.valid}" id="farm" name="farm" placeholder="{{ trans('admin.task.columns.farm') }}">

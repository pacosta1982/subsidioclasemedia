...
class FillPermissionsForWorkflowState extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForWorkflowState constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.workflow-state.index',
            'admin.workflow-state.create',
            'admin.workflow-state.show',
            'admin.workflow-state.edit',
            'admin.workflow-state.delete',
            'admin.workflow-state.bulk-delete',
        ]);

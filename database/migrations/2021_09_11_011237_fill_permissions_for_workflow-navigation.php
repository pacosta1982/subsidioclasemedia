...
class FillPermissionsForWorkflowNavigation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForWorkflowNavigation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.workflow-navigation.index',
            'admin.workflow-navigation.create',
            'admin.workflow-navigation.show',
            'admin.workflow-navigation.edit',
            'admin.workflow-navigation.delete',
            'admin.workflow-navigation.bulk-delete',
        ]);

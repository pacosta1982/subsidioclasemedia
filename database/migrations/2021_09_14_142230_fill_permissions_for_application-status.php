...
class FillPermissionsForApplicationStatus extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForApplicationStatus constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.application-status.index',
            'admin.application-status.create',
            'admin.application-status.show',
            'admin.application-status.edit',
            'admin.application-status.delete',
            'admin.application-status.bulk-delete',
        ]);
